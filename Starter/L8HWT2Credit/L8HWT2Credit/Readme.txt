...
+Попросить экономиста ввести сумму платежа
+Создать метод Credit(), который будет выводить на экран сумму долга, предоплаты либо отсутствии задолженности
	+Иницилизировать переменную debt = 700, сравить сумму платежа и, используя метод if вывести на экран результат
