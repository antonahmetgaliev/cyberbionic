...
+Попросить ввести индекс нового элемента
+Попросить ввести значение нового элемента
+Создать метод, который будет возвращать массив с новым элементом 
+Создать метод, который будет выводить массивы на экран