...
+Задать переменным некоторые  произвольные значения.
+Предложить пользователю ввести знак арифметической операции. 
+Принять значение введенное пользователем и поместите его в строковую переменную sign.  
...
+В случае использования операции деления, организовать проверку попытки деления на ноль.
+Сделано. 